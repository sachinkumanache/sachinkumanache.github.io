...
function HomeSection() {
    const downloadHandle = () => {
        ...
        link.download = "SachinKumanache-Resume.pdf";
        link.href = MyResume;
        link.setAttribute("class", "resume-link-2")
        link.click();

        window.open(
          "https://drive.google.com/file/d/1wIXg33r_0CU5_ZXI63OXzl7cDWGluM5c/view?usp=sharing",
          "_blank"
        );
    };

    const githubHandle = () => {
        window.open("https://github.com/sachinkumanache", "_blank");
    };
    return (
        <div id='home'>
            <div id='left_home'>
                <div>
                    <h1>Hi, I am</h1>
                    <h1 id="user-detail-name">Sachin Kumanache</h1>
